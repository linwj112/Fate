...
def show_result(result_data,f_number):   #顯示宮位主星說明
    ...
    explain_star_10={'紫微':"人生的皇宮",
                  ...
                  '右弼':"整排的建築物(但不一定是建築物，可能是河堤)。右弼，右邊一整排",
    ...
    frd_number={'命宮':'1','兄弟宮':'2','夫妻宮':'3','子女宮':'4',
                '財帛宮':'5','疾厄宮':'6','遷移宮':'7','僕役宮':'8',
                '官祿宮':'9','田宅宮':'10','福德宮':'11','父母宮':'12'}
    ...
    if (frd[frd_name].get(assemb_star) != None) and (flag_star == 2) :
        opflname = frd[frd_name][assemb_star]+'-'+frd_number[frd_name]+'.rd'
        text_sr.insert(END,frd[frd_name][assemb_star] +"\n")
        with open('.\\result\\'+opflname, 'r',encoding='utf-8') as inputfile:
            explain_twice = inputfile.read()
            text_sr.insert(END,explain_twice +"\n")
            text_sr.insert(END,"\n")    
    #print('雙星同宮說明')
